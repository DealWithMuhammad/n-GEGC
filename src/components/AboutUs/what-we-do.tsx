import WhatWeDoCard from "@/components/AboutUs/what-we-do-card";
import Link from "next/link";

export default function WhatWeDo() {
  return (
    <section className="py-10 mx-10 lg:py-14" id="what-we-do">
      <article className="container grid gap-8">
        <h2 className="text-black font-sans font-extrabold text-2xl md:text-5xl">
          What We Do
        </h2>
